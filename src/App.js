...
function App() {
  const [movies,setMovies]=useState([
    ...
    {title:"I am legend", description :"Robert Neville était un brillant scientifique, mais même lui n'a pu endiguer le terrible virus - créé de la main de l'homme - qui a dévasté la race humaine. Pour une raison inconnue, Neville est immunisé et reste à ce jour le dernier être humain vivant dans ce qui reste de New York" ,posterURL:"https://resizing.flixster.com/vYsn-bvQtSrZJ3e_4nAdmkG89hA=/206x305/v2/https://flxt.tmsimg.com/assets/p170977_p_v7_ae.jpg",rating : 4 , id : Math.random(),trailer:"https://www.youtube.com/embed/dtKMEAXyPkg"}
  ])
